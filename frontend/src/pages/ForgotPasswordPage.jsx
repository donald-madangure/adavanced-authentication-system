 ...
 const handleSubmit = async (e) => {
  ...
  return (
    ...
    initial={{ opacity: 0, y: 20 }}
			...
			className='max-w-md w-full bg-gray-700 bg-opacity-50 backdrop-filter 
    ...
    >
        ...
        {!isSubmitted ? (
					...
					<div className='text-center'>
						<motion.div
							...
							className='w-16 h-16 bg-lime-500 rounded-full flex items-center justify-center mx-auto mb-4'
						>
      ...
      <div className='px-8 py-4 bg-gray-900 bg-opacity-50 flex justify-center'>
				<Link to={"/login"} className='text-sm text-lime-400 hover:underline flex items-center'>
