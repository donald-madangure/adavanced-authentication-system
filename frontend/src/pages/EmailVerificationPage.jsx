    ...
    >
        ...
        <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            <motion.button
						...
						className='w-full bg-gradient-to-r from-lime-500 to-lime-600 text-white font-bold py-3 px-4 rounded-lg 
                        shadow-lg hover:from-lime-600 hover:to-lime-700 focus:outline-none focus:ring-2
                         focus:ring-lime-500 focus:ring-opacity-50 disabled:opacity-50'
					>
